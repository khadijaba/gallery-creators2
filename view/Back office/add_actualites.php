...
if (
    ...
    if (
        ...
        $actualitesC->addActualite($actualite);
...
<head>
    ...
    <title>Formulaire d'inscription d'actualité</title>
</head>
<body>
    <div class="container">
        ...
        <div class="col50">
            <div class="image-slideshow">
                <div class="image fade">
                    <img src="../Front office/assets/wallpaperflare.com_wallpaper_1.jpg">
                </div>     
                <div class="image fade">
                    <img src="../Front office/assets/painting.jpg">
                </div>
                <div class="image fade">
                    <img src="../Front office/assets/painting2.jpg">
                </div>
              </div>
        </div>
    </div>
